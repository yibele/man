        ...
        <div class='charges_content'>
            <div class='charges_col1'>
                <div class='charges_detail'>
                    <h4>
                    <?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>慢递鱼是什么?</h4> 
                ...
                <div class='charges_detail'>
                    <h4>
                    <?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>资费是多少，怎样邮寄?
                    </h4>
                    
                    <p style="padding:10px 20px 30px 47px">信件和明信片邮寄价格均为19.9元。2年内免费保管，超出2年保管费为每年5元。信件采用顺丰快递邮寄，最大限度保证收到信件。</p>
                </div>
                <div class='charges_detail'>
                    <h4> <?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>怎样寄明信片和写信？</h4>
...
3.完成以上就可以去支付了，支持支付宝或微信支付。然后就安心等待收信吧！</p>
                ...
                <div class='charges_detail'>
                    <h4><?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>公开信是什么？</h4>
                    <p style='padding:10px 20px 30px 47px'>公开信是用户授权慢递鱼公开分享的信件。你也可以在写信结束后选择公开自己的信件和别人分享。</p>
                </div>
                <div class='charges_detail'>
                    <h4><?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>可以补充或修改收信人吗？</h4>
                ...
                <div class='charges_detail'>
                    <h4><?= $this->tag->image(['img/charges/charges_icon_03.png', 'class' => 'charges_icon']) ?>无法寄送的信件怎样处理？</h4>
            ...
            <div class='charges_col2'>
                ...
                <p>客服邮件: <?= $kefuEmail ?></p>
                <p>意见建议: <?= $yijianEmail ?></p>
                <p>微信公众号: <?= $gongzhonghao ?></p>
                <?= $this->tag->image(['img/index/erweima_07.png', 'style' => 'margin-top:40px;']) ?>
            </div>
    </div>
